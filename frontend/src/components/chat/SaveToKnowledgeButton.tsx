...
import { CheckCircle2, Loader2, FolderOpen, Save, X } from 'lucide-react';
    ...
    <>
      ...
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-card border border-border rounded-2xl shadow-lg w-full max-w-sm mx-4">
            {/* Header */}
